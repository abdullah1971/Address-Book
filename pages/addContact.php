      ...
      <div class="starter-template">
        ...
        <div class="container">
              <div class="row main">
                ...
                <h5>New Contact's Info</h5>
                  <form class="" method="post" action="addingContact.php">
                    ...
                    <div class="form-group">
                      ...
                      <div class="cols-sm-10">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="phoneNo" id="phoneNo"  placeholder="For more than one use ','" required />
                        </div>
                      </div>
                    </div>
